...
templates['details-template'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<section class=\"container-fluid\" id=\"banner-small\"></section>\r\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"data") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":2,"column":4},"end":{"line":7,"column":13}}})) != null ? stack1 : "");
},"useData":true});
templates['news-template'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "      <div class=\"col\">\r\n        <div class=\"float-start me-3\">\r\n          <div class=\"date text-white text-center rounded-4 py-1\">\r\n            <h3>"
    ...
    + "</h3>\r\n          </div>\r\n          <a href=\"#\" class=\"btn btn-link readmore ps-0\" onclick=\"loadData('news/"
  ...
  return "<h1 class=\"text-black-10\">News</h1>\r\n    <div class=\"row py-3\">\r\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"data") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":3,"column":6},"end":{"line":16,"column":15}}})) != null ? stack1 : "")
    + "    </div>";
},"useData":true});
templates['products-template'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <div class=\"col-lg-3 col-md-6 col-sm-12\">        \r\n      <img src=\""
    ...
    + "</h3>\r\n      <p>"
    + alias2(alias1((depth0 != null ? lookupProperty(depth0,"summary") : depth0), depth0))
    + "</p>\r\n      <a class=\"readmore btn btn-link pt=0\" href=\"#\"\r\n         onclick=\"loadData('products/"
    + alias2(alias1((depth0 != null ? lookupProperty(depth0,"id") : depth0), depth0))
  ...
  return "<div class=\"row text-center py-5\">\r\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"data") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":2,"column":4},"end":{"line":11,"column":13}}})) != null ? stack1 : "")
    + "  </div>";
},"useData":true});
})();